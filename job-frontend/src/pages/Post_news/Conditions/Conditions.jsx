      ...
      <div className={`setup-wrapper ${collapsed ? 'collapsed' : ''}`}>
        <div className="setup-card">
          ...
          <p className="setup-subtitle">
            Hãy thực hiện các bước sau để có thể có được trải nghiệm tốt nhất tại MyCV
          </p>

          <div className="setup-list">
            {steps.map((step, index) => {
              // LOGIC KHÓA:
              // 1. Bước 1 (index 0) và Bước 2 (index 1) luôn khả dụng.
              // 2. Bước 3 (index 2) khóa nếu Bước 2 chưa xong.
              // 3. Bước 4 (index 3) khóa nếu bất kỳ bước 1, 2, 3 nào chưa xong.
              let isLocked = false;
              if (index === 2) {
              ...
              return (
                ...
                >
                  <div className="setup-left">
                    <span className={`setup-check ${step.done ? "done" : "pending"}`}>
                      {step.done ? "✔" : ""}
                    </span>
                  ...
                  <button 
                    ...
                    disabled={isLocked}
                    title={isLocked ? "Vui lòng hoàn thành các bước trước" : ""}
                  >
                    ➜
                  </button>
                </div>
          ...
          <div className="setup-progress-section">
            <span className="setup-percent">Hoàn thành {percent}%</span>
